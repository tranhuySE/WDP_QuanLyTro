...
// --- NEW: Cập nhật style cho modal ---
const modalStyle = {
  position: "absolute",
  top: "50%",
  left: "50%",
  transform: "translate(-50%, -50%)",
  width: { xs: "95%", sm: 600, md: 700 }, // Responsive width
...
const InvoiceDetailModal = ({ invoiceId, open, onClose }) => {
  ...
  // --- NEW: Giao diện hiển thị hóa đơn được thiết kế lại hoàn toàn ---
  const renderContent = () => {
    if (isLoading) {
      return (
            ...
            <Grid item xs={12} md={6}>
              <Stack spacing={2}>
                <InfoItem
                  ...
                  primary="Người thuê"
                  secondary={invoice.create_by?.fullname}
                />
                <InfoItem
