...
const TenantLayout = () => {
    ...
    const navItems = [
        ...
        { path: '/tenant/users', label: 'Thông tin phòng', icon: HousePlus },
        { path: '/tenant/invoices', label: 'Hóa đơn', icon: FileText },
        { path: '/tenant/payment-history', label: 'Lịch sử thanh toán', icon: CardSim },
